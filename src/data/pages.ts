...
export const pageMeta: Record<string, Record<Lang, PageMeta>> = {
  "about.html": {
    sv: {
      ...
      description:
        "Om Total Digital: vår historia, ledningen, de tretton orter vi arbetar från, ISO 9001- och 14001-certifiering samt karriär och examensarbete.",
    },
    en: {
      title: "About us | Total Digital",
      description:
        "About Total Digital: our history, the management team, the thirteen locations we work from, ISO 9001 and 14001 certification, plus careers and degree projects.",
    },
  },
  "index.html": {
    sv: {
      ...
      description:
        "Total Digital förenar tillgångsförvaltning, geodata, fjärranalys och AI – specialistkompetens som kopplar samman anläggningens skick, läge och utveckling.",
    },
    en: {
      title: "Total Digital – Asset management, geodata, remote sensing and AI",
      description:
        "Total Digital brings together asset management, geodata, remote sensing and AI – specialist expertise connecting the condition, location and development of your assets.",
    },
  },
  "leak-detection.html": {
    sv: {
      ...
      description:
        "AI och satellitdata som upptäcker läckage i vattendistributionsnät, minskar vattenförluster och ger bättre underlag för förvaltning av ledningsnätet.",
    ...
    en: {
      ...
      description:
        "AI and satellite data that detect leaks in water distribution networks, reduce water losses and give a better basis for managing the pipe network.",
  ...
  "raildamage-analyses.html": {
    sv: {
      ...
      description:
        "AI-baserad analys av bilddata från järnvägsinspektioner som identifierar rälsskador och avvikelser – stöd för tillståndsbedömning och underhållsplanering.",
    ...
    en: {
      ...
      description:
        "AI-based analysis of image data from railway inspections that identifies rail defects and anomalies – support for condition assessment and maintenance planning.",
  ...
  "railway-safety.html": {
    sv: {
      ...
      description:
        "AI och satellitdata som prognosticerar rälstemperatur och risk för spårförskjutning upp till 48 timmar i förväg – för proaktivt underhåll och säkrare järnvägsdrift.",
    ...
    en: {
      ...
      description:
        "AI and satellite data that forecast rail temperature and the risk of track buckling up to 48 hours ahead – for proactive maintenance and safer railway operations.",
  ...
  "sar-processing.html": {
    sv: {
      ...
      description:
        "InSAR-baserad bearbetning av hög- och medelupplöst SAR-data för övervakning av markrörelser och deformationer inom infrastruktur och samhällsbyggnad.",
    ...
    en: {
      ...
      description:
        "InSAR-based processing of high- and medium-resolution SAR data for monitoring ground motion across infrastructure and the built environment.",
  ...
  "td_asset_care.html": {
    sv: {
      ...
      description:
        "TD Asset Care är en heltäckande, beprövad lösning för förvaltning och underhåll av fysiska tillgångar. Branschspecifika funktioner, drift on-prem, hybrid eller i molnet.",
    ...
    en: {
      ...
      description:
        "TD Asset Care is a complete, proven solution for managing and maintaining physical assets. Industry-specific functionality, deployed on-premises, hybrid or in the cloud.",
  ...
  "td_linear.html": {
    sv: {
      ...
      description:
        "TD Linear visualiserar och analyserar data längs linjära tillgångar som järnväg, väg, kraftledningar samt vatten- och avloppsnät. EAM-, mät- och kartdata i en gemensam vy.",
      ogTitle: "TD Linear – Förstå era linjära tillgångar",
      ogImage: "https://www.totaldigital.se/images/og/td_linear.jpg",
      ogImageAlt: "TD Linear",
      ldName: "TD Linear",
      applicationCategory: "BusinessApplication",
    },
    en: {
      ...
      description:
        "TD Linear visualises and analyses data along linear assets such as railway, road, power lines as well as water and wastewater networks. EAM, measurement and map data in one shared view.",
  ...
  "td_test.html": {
    sv: {
      ...
      description:
        "TD Test är verktyget för automatiserade tester av IBM Maximo och Maximo Application Suite (MAS). Testar gränssnitt, affärslogik och integrationer m.m.",
    ...
    en: {
      ...
      description:
        "TD Test is the tool for automated testing of IBM Maximo and Maximo Application Suite (MAS). Tests the interface, business logic, integrations and more.",
